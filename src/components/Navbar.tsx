        ...
        <div className="flex h-16 items-center justify-between">
          <Link to="/" className="flex items-center gap-3 group">
            <img
              ...
              className="h-8 w-auto rounded px-1"
              src="/lovable-uploads/cf76aca7-8a99-4b68-90c0-85a491f297ed.png"
            />
            ...
            {links.map(({ to, label, icon: Icon }) => {
              ...
              return (
                <Link
                  key={to}
                  to={to}
                  className={`flex items-center gap-2 px-4 py-2 rounded-md font-mono text-sm transition-all ${isActive ? "bg-primary/10 text-primary glow-border" : "text-muted-foreground hover:text-foreground hover:bg-secondary"}`}
                >
